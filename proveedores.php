...
echo '<p><label for="nit">NIT:</label><input class=""name="nit"type="text" id="nit" value="';if (isset($row['nit'])) echo $row['nit'];echo '"';echo '></p>';
...
echo '<p><label for="nombre">Nombre:</label><input class=""name="nombre"type="text" id="nombre" value="';if (isset($row['nombre'])) echo $row['nombre'];echo '"';echo '></p>';
echo '<p><label for="telefono">Teléfono:</label><input class=""name="telefono"type="text" id="telefono" value="';if (isset($row['telefono'])) echo $row['telefono'];echo '"';echo '></p>';
echo '<p><label for="direccion">Dirección:</label><input class=""name="direccion"type="text" id="direccion" value="';if (isset($row['direccion'])) echo $row['direccion'];echo '"';echo '></p>';
echo '<p><label for="correo">Correo:</label><input class=""name="correo"type="text" id="correo" value="';if (isset($row['correo'])) echo $row['correo'];echo '"';echo '></p>';
...
echo '<p><label for="observacion">Observación:</label></p><p><textarea class="" name="observacion" cols="60" rows="10"id="observacion" >';if (isset($row['observacion'])) echo $row['observacion'];echo '</textarea></p>';
